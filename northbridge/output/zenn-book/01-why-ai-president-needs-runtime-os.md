...
Claude Code や Codex を「社長」として置き、ローカルLLMを「部下ワーカー」として持たせる。
それだけでも、単体のチャットよりはるかに整理された仕事ができる。

しかし、実際に手を動かしてみると、すぐ別の問題にぶつかる。
...
言い換えると、Southgate本が「組織の発明」なら、Northbridge本は **「組織の運用」** を扱う。
...
Northbridge は、AI組織が雑になった時にそれを止める側でもある。
