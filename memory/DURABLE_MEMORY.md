...
- the Northbridge book is being polished toward a stronger, more opinionated runtime/operations voice rather than a neutral documentation tone
- delegated review is now part of the book-polish process; the main lesson from that pass is to keep one canonical publish path (`books/ai-president-runtime-os-guide/`) and treat `northbridge/output/zenn-book/` as archival/supporting material
